...
There's a sharp switch in the number of consumer finance and retail tradelines early on in the data. We want to see if this explains the sharp changes and if dropping the tradelines that are all zeros helps
...
_______
    ...
    ~/projects/equifaxmacro_proj/EquiFax3/4_Summary_Statistics/output/6_retail_cons_fin.csv
        ...
        balances and number of tradelines for retail and consumer finance tradelines
